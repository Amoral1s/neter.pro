    ...
    <div itemscope itemtype="https://schema.org/FAQPage" class="wrap">
      ...
      <div class="answers <?php if ($i == 0) { echo 'active'; } ?>">
        <?php if (have_rows('rows')) : while(have_rows('rows')) : the_row(); ?>
          <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question" class="answer">
            <div class="answer-title">
              <span itemprop="name"><?php echo get_sub_field('question'); ?></span>
              <div class="icon">
            ...
            <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer" class="answer-content ">
              <div itemprop="text" class="contnent">
