					...
					<div class="catalog-view">
						...
						<div class="catalog-view__toggle icon <?php echo $catalog_view === 'table' ? 'active' : ''; ?>" data-view="table">
							<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
								...
								<path d="M2 19.4C2 18.2417 2.24173 18 3.4 18H20.6C21.7583 18 22 18.2417 22 19.4V20.6C22 21.7583 21.7583 22 20.6 22H3.4C2.24173 22 2 21.7583 2 20.6V19.4Z" stroke="#2CB4C2" stroke-width="1.5" stroke-linecap="round"/>
							</svg>
						</div>
					</div>
				</div>
					...
					<div class="swiper">
						<div class="swiper-wrapper our-row-wrap">
							<?php
								...
								<?php if (have_rows('cat_row', 'options')) : ?>
										<?php while (have_rows('cat_row', 'options')) : the_row(); ?>
												<?php 
												$link = get_sub_field('link');
												$parsed_url = parse_url($link);
												$path_segments = explode('/', trim($parsed_url['path'], '/'));
												$link_slug = end($path_segments);

												if ($link_slug !== $current_category_slug) : ?>
														<a href="<?php echo esc_url($link); ?>" class="item swiper-slide">
																<div class="icon">
																		<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
																...
																<img src="<?php echo esc_url(get_sub_field('img')); ?>" alt="<?php echo esc_attr(get_sub_field('title')); ?>">
														</a>
												<?php endif; ?>
										<?php endwhile; ?>
								<?php endif; ?>
