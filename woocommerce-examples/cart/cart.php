	...
	<div class="cart-wrap">
		<div class="cart-left">
			...
			<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
				...
				<div class="cart-content shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
						...
						if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
							...
							<div class="item woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
								...
								<div class="product-name" data-title="<?php esc_attr_e( 'Product', 'woocommerce' ); ?>">
									...
									<?php if (get_field('installation_price', $_product->get_id())) :
											$checked = isset($cart_item['installation']) ? 'checked' : '';
									?>
											<div class="setup">
													<input type="checkbox" id="installation-checkbox-<?php echo $_product->get_id(); ?>" class="installation-checkbox" data-cart-item-key="<?php echo $cart_item_key; ?>" <?php echo $checked; ?>>
													<label for="installation-checkbox-<?php echo $_product->get_id(); ?>">
															<span>
																	<svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
																			<path d="M13.2305 5.5L6.86683 11.3333L3.23047 8" stroke="white" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
																	</svg>
															</span>
															<p>Монтаж</p>
													</label>
...
<script>
	...
	jQuery('body').on('click', '.plus', function() {
		...
		jQuery(this).closest('.quantity').find('.qty').trigger('change');
