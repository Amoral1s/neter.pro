...
<?php if (get_field('sept_banner_title', 'options')) : ?>
<section class="sept-banner anti-container">
  <div class="container">
    <div class="wrap">
      <div class="left">
        <h2 class="title title-sub"><?php echo get_field('sept_banner_title', 'options') ?></h2>
        <p class="subtitle"><?php echo get_field('sept_banner_subtitle', 'options'); ?></p>
      </div>
      <div class="right form">
        <?php echo do_shortcode('[contact-form-7 id="a1f5e34" title="Баннер Подбор септика"]'); ?>
      </div>
    </div>
  </div>
  <div class="bg">
    <img class="line" src="<?php echo get_template_directory_uri(); ?>/img/sept-banner-line.svg" alt="BG">
    <svg xmlns="http://www.w3.org/2000/svg" width="414" height="306" viewBox="0 0 414 306" fill="none">
      <path d="M345.328 306H11.895V246.76H345.266C362.952 246.76 377.463 232.307 377.463 214.69C377.463 197.073 362.952 182.62 345.266 182.62H91.6722C41.103 182.62 0 141.679 0 91.31C0 40.9406 41.103 0 91.6722 0H425.043V59.2398H91.6722C73.9855 59.2398 59.4748 73.6931 59.4748 91.31C59.4748 108.927 73.9855 123.38 91.6722 123.38H345.328C395.897 123.38 437 164.321 437 214.69C437 265.059 395.897 306 345.328 306Z" fill="black"/>
      <path d="M345.328 306H11.895V246.76H345.266C362.952 246.76 377.463 232.307 377.463 214.69C377.463 197.073 362.952 182.62 345.266 182.62H91.6722C41.103 182.62 0 141.679 0 91.31C0 40.9406 41.103 0 91.6722 0H425.043V59.2398H91.6722C73.9855 59.2398 59.4748 73.6931 59.4748 91.31C59.4748 108.927 73.9855 123.38 91.6722 123.38H345.328C395.897 123.38 437 164.321 437 214.69C437 265.059 395.897 306 345.328 306Z" fill="url(#paint0_linear_252_372)"/>
      <defs>
      <linearGradient id="paint0_linear_252_372" x1="7.58927e-05" y1="-46.4034" x2="447.244" y2="-28.8068" gradientUnits="userSpaceOnUse">
...
<?php if (get_field('calc_title', 'options')) : ?>
<section class="calc calc-septik-wrap bg-gray anti-container">
  <div class="container">
    <div class="calc-wrap">
      <div class="left">
...
<section class="popular">
  <div class="container">
    <h2 class="title">Товары этого бренда</h2>
...
<?php if (get_field('brands_title', 'options')) : ?>
<section class="brands <?php if ($actions == true) echo 'page-brands'; ?> anti-container">
...
<?php if (get_field('any_title', 'options')) : ?>
<section class="any page-any single-any" style="margin-bottom: 0;">
  <div class="container">
    <div class="wrap">
      <div class="left">
